...
function submit() {
  ...
  for(var i = 0; i < letters.length; i++){
    unsortedAnswer.push(letters[i].value.toUpperCase(), rows[i].value.toUpperCase() + columns[i].value.toUpperCase())
...
function exportFile()
    {
        var data = [unsortedRecord, allMovesRecord, participantInfo];
        //var data = [[1,2,3,4,5],[11,22,33,44,55],[111,222,333,444,555],[1111,2222,3333,4444,5555]];
        var keys = ['"Times and Form Entry"', '"Dragged moves"', '"Participant Info"'];
