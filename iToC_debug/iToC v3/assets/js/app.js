...
function exportFile()
    {
        var data = [unsortedRecord, thinkTime, answerTime, participantInfo];
        var keys = ['"Answers submitted"','"Thinking Time (seconds)"','"Data Entry Time (seconds)"', '"Participant Info"'];
...
$("#export").on("click", function(){
  ...
  participantNum = "C" + (Math.floor(Math.random()*90000) + 10000);
